...
class SettingsController: UITableViewController {
    ...
    func configureNavigationBar() {
        ...
        navigationItem.title = "My Settings"
...
extension SettingsController {
    ...
    override func tableView(_ tableView: UITableView, viewForHeaderInSection section: Int) -> UIView? {
        ...
        title.text = "My Favorite Destinations"
...
//MARK: - AddLocationProtocolDelegate

extension SettingsController: AddLocationProtocolDelegate {
    func updatLocation(locationString: String, type: LocationType) {
        PassengerService.shared.saveLocation(locationString: locationString, type: type) { (err, ref) in
            ...
            self.tableView.reloadData() //all that tableView funcs will run again
